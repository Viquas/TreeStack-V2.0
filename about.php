          ...
          <div class="col-sm-8">
            <div class="box-detail b-x" id="box-one-ts">
              <div class="big-pad-right">
                ...
                <p class="explain ">TreeStack becomes an integral part of your team,
                accomplishing a balance between our methodology and yours.  </p>
                <br/>
                <div class="circle-arrow l-mtop fleft" >
      ...
      <div class="container">
        ...
        <div class="row ts-t-b">
          <div id="processHolder">
            ...
            <h1 class="p-number">04</h1>
            <h1 class="p-number">05</h1>
            <h1 class="p-number">06</h1>
          </div>
         </div>
        </div>
        <div class="row">
          ...
          <div class="col-sm-12">
          <div class="p-head ">
            <p class="p-text" data-id="0">Brief</p>
            <div class="p-line"></div>
            <p class="p-text" data-id="1">Research</p>
            <div class="p-line"></div>
            <p class="p-text" data-id="2">Strategy</p>
            <div class="p-line"></div>
            <p class="p-text" data-id="3">Design</p>
            <div class="p-line"></div>
